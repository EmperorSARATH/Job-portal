...
const HomeUserSelection = forwardRef<HTMLDivElement>((_, ref) => {
    ...
    return (
        <div
            ...
            min-h-screen py-10 md:py-0
            bg-gradient-to-br from-slate-50 via-white to-slate-100
            overflow-hidden px-4 sm:px-6 gap-6 sm:gap-8 md:gap-0"
        >
            {/* Employee Card */}
            <div
                onMouseEnter={() => setHovered('employee')}
                onMouseLeave={() => setHovered(null)}
                className={`group relative w-full max-w-xs sm:max-w-sm border border-gray-200 shadow-lg rounded-2xl p-5 sm:p-8 bg-white
            ...
            >
                ...
                <h1
                    className="text-center text-3xl sm:text-4xl md:text-5xl text-black"
                    style={{ fontFamily: "'Lobster', cursive" }}
                >
                    Employee
                </h1>
                <p className="mt-2 sm:mt-3 text-center text-base sm:text-lg text-gray-500">
                    Looking for your next opportunity?
                </p>

                <div className="mt-5 sm:mt-6 flex flex-col gap-3">
                    <Link href="/login" className="w-full">
                        <button className="w-full bg-black text-white px-4 py-3 rounded-lg font-medium text-sm sm:text-base
                    ...
                    <Link href="/Registration/EmployeeReg" className="w-full">
                        <button className="w-full border-2 border-green-500 text-green-600 px-4 py-3 rounded-lg font-medium text-sm sm:text-base
            ...
            {/* Divider */}
            <div className="hidden md:flex flex-col items-center justify-center mx-6 lg:mx-8 shrink-0">
                <span className="h-20 lg:h-24 w-px bg-gray-300" />
                <span className="my-3 text-sm font-semibold text-gray-400 tracking-widest">OR</span>
                <span className="h-20 lg:h-24 w-px bg-gray-300" />
            </div>

            {/* Mobile-only divider */}
            <div className="flex md:hidden items-center w-full max-w-xs sm:max-w-sm">
                <span className="flex-1 h-px bg-gray-300" />
                <span className="mx-3 text-xs font-semibold text-gray-400 tracking-widest">OR</span>
                <span className="flex-1 h-px bg-gray-300" />
            </div>
            ...
            >
                ...
                <div className="mt-5 sm:mt-6 flex flex-col gap-3">
                    ...
                    <Link href="/Registration/EmployeeReg" className="w-full">
                        <button className="w-full border-2 border-blue-500 text-blue-600 px-4 py-3 rounded-lg font-medium text-sm sm:text-base
